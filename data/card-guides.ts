...
export const transportGuides: Record<string, TransportGuide> = {
  nex_arrival: {
    booking: "After customs target N’EX 40: Narita T1 17:16 → Tokyo 18:18. Verified backup N’EX 42 is 17:45 → 18:48. Buy four one-way Ordinary reserved tickets after landing; the 14-day round-trip product cannot span this 16-day trip.",
    seats: "Ordinary is a comfortable 2+2 layout. Choose the complete A/B + C/D row, or the same pairs in two consecutive rows. Green Car adds space but no useful time saving or special view.",
  ...
  nex_departure: {
    booking: "Reserve verified N’EX 17 now: Shinjuku 10:09 → Narita T1 11:27. Verified backup N’EX 19 is 10:38 → 11:57. Ordinary reserved is sufficient; Green Car is optional luxury, not an airport advantage.",
    seats: "Book the complete A/B + C/D row, or the same two-seat pairs in consecutive rows. Pick a car convenient to the luggage rack; the view is not side-dependent.",
  ...
  tokaido_fuji: {
    booking: "Reserve the exact calendar train in SmartEX now. Ordinary reserved is best value; Green Car is a 2+2 splurge, not necessary for these journeys.",
    seats: "Choose D/E in two consecutive rows—such as 12D/E + 13D/E—so the family stays together and both E seats are Mount Fuji-side windows in either direction.",
  ...
  tokaido_short: {
    booking: "Reserve verified Kodama 801 in SmartEX: Tokyo 06:30 → Odawara 07:03. Ordinary reserved is ideal; this 33-minute leg is too short to justify Green Car.",
  ...
  sanyo_west: {
    booking: "Reserve verified Nozomi 101 through JR West: Shin-Osaka 07:09 → Hiroshima 08:36. Use the Kansai–Hiroshima Area Pass; Green Car is not included or needed.",
    seats: "Take two D/E pairs in consecutive rows. E is the north/inland window and offers the better chance of the brief Himeji Castle view; A is the south side, but scenery is intermittent.",
    luggage: "With only overnight bags, use overhead racks. Oversized bags still require the designated baggage-area seats.",
    fallback: "If unavailable, compare the next departures in live JR West inventory. Obon Nozomi trains are reserved-seat-only, so do not rely on standing or unreserved cars.",
  },
  sanyo_east: {
    booking: "Reserve verified Nozomi 2 through JR West: Hiroshima 07:08 → Shin-Osaka 08:28. Use the Kansai–Hiroshima Area Pass; do not pay to upgrade outside it.",
    seats: "Take two D/E pairs in consecutive rows. E remains the north/inland window and is the useful side for the brief Himeji Castle view; keeping the family together matters more than scattered windows.",
  ...
  hakone_local: {
    booking: "No seat reservations. At Odawara East Exit use platform 3 for the H-Line bus and target roughly 07:16–07:20. Use the digital Hakone Freepass and verify the live board because road traffic can change the schedule.",
  ...
  miyajima: {
    booking: "JR local train and ferry need no reservation and are covered by the regional pass. Target the verified 06:25 ferry; the next is 07:05. Pay the separate ¥100-per-person visitor tax.",
    ...
    fallback: "If the 06:25 ferry is missed, take the 07:05 sailing. The close-to-torii sightseeing course runs only 09:10–16:10; keeping the early ferry is the better crowd trade-off.",
  },
  metro: {
