...
export function TripCalendar() {
  ...
  return (
    <main className="shell">
      ...
      {isEditor && draft && <Editor item={draft} setItem={setDraft} onSave={saveDraft} onDelete={removeDraft} onClose={() => setDraft(null)} onReset={() => { if (confirm("Restore the verified complete itinerary for everyone?")) { setDraft(null); void resetDefaults(); } }} busy={locating} attachmentsEnabled={items.some((candidate) => candidate.id === draft.id)} />}
